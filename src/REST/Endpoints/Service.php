 ...
 * @method int|null getNextInvoicingDayAdjustment()
 * @method Service setNextInvoicingDayAdjustment(int $adjustment)
...
final class Service extends EndpointObject
{
    ...
    {
        $this->activeFrom = $date->format(self::DATETIME_FORMAT);
        return $this;
    }
    ...
    {
        $this->activeTo = $date->format(self::DATETIME_FORMAT);
        return $this;
    }
    ...
    {
        $this->invoicingStart = $date->format(self::DATETIME_FORMAT);
        return $this;
    }
    ...
    {
        $this->contractEndDate = $date->format(self::DATETIME_FORMAT);
        return $this;
    }
    ...
    {
        $this->discountFrom = $date->format(self::DATETIME_FORMAT);
        return $this;
    }
    ...
    {
        $this->discountTo = $date->format(self::DATETIME_FORMAT);
        return $this;
    }
