...
use SpaethTech\UCRM\SDK\REST\Annotations\KeepNullElementsAnnotation as KeepNullElements;
...
final class Invoice extends EndpointObject
{
    ...
    {
        $this->emailSentDate = $value->format(self::DATETIME_FORMAT);
        return $this;
    }
    ...
    {
        $this->dueDate = $value->format(self::DATETIME_FORMAT);
        return $this;
    }
